...
When used as an input to the gravity model, this distance produces better predictions than geographic distance using both the exponential and power-law models. 
