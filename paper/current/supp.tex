...
\begin{figure}[p!]
	...
	\caption{
		...
		Results here are identical to those shown in Fig.2.
...
\begin{figure}[p!]
	...
	\caption{
		...
		a perfect prediction yields all points on the black line.
		\textbf{a-b.} Predictions are made with parameters estimated from all pairs of organizations (as in Fig.2e), and showing only the subsets of predictions for organization pairs in the same country (\textbf{a}) and in different countries (\textbf{b}).
		...
		this is the same data as shown in Fig.2f and Fig.2h.
	}
