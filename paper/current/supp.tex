...
To evaluate the ability \textit{word2vec} to recover the known gravity-like structure of the synthetic data, we compare the embedding distance to the distances between the 1,000 points in the synthetic space, $r_{ij}^{synthetic}$ using the Pearson correlation coefficient. 
...
In Fig. \ref{fig:supp:synthetic_robust}) presents the average Pearson correlation between the synthetic and embedding distance over ten iterations with for different values of $k$ and $\beta$. 
