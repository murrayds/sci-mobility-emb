...
\author[1,4]{Dakota Murray}
\author[1, 2, 4]{Jisung Yoon}
\author[1]{Sadamori Kojaku}
\author[3]{Rodrigo Costas}
\author[2]{Woo-Sung Jung}
\author[1]{Staša Milojević \thanks{smilojev@indiana.edu}}
\author[1]{Yong-Yeol Ahn \thanks{yyahn@iu.edu}}
...
\affil[4]{These authors contributed equally: Jisung Yoon, Dakota Murray.}
...
Here, using a massive dataset of scientific mobility, U.S. flight itineraries and Korean accommodation reservation, we demonstrate that a neural embedding model~\autocite{mikolov2013word2vec} can encode nuanced relationships between locations into a vector-space, providing an effective functional distance that reflects the multi-faced structure of human mobility. 
...
We leverage three massive datasets: a dataset of U.S. passenger flight itinerary records, Korean accommodation reservation records, and a dataset of scientists' career mobility between organizations captured in bibliometric records. 
In particular, we focus on scientific mobility due to its richness and importance. Scientific mobility, which is a central driver of the globalized scientific enterprise~\autocite{czaika2018globalisation, altbach2004globalization, box2008competition} and strongly related to innovation~\autocite{braunerhjelm2020labor, kaiser2018innovation, armano2017innovation}, impact~\autocite{sugimoto2017mostimpact, petersen2018multiscale, franzoni2014advantage}, collaboration~\autocite{rodrigues2016mobility}, and the diffusion of knowledge~\autocite{braunerhjelm2020labor, azoulay2011diffusion, morgan2018prestige}, is not only an important topic in the Science of Science but also ideal for our study thanks to its richness and well-known structural properties such as the centrality of scientifically advanced countries and the strong prestige hierarchy~\autocite{auriol2010careers, clauset2015hierarchy, deville2014career}. 
...
The Korean accommodation reservation records consist of accommodation reservation history between 2018 and 2020 between 1,038 unique accommodation in Seoul, South Korea.
A trajectory is constructed for each customer's accommodation reservation history, constructing an ordered sequence of unique commendation with accurate location information.
...
We source Korean accommodation reservation data from collaboration with Good Choice Company in Korea. Each trajectory is the sequence of reserved accommodation in Seoul, South Korea between 2018.08.01 ~ 2020.07.31, comprising 938,962 trajectories consist of  1,038 unique accommodations.
...
\begin{figure}[]
	...
	\caption{\textbf{Extent and nature of mobility by country.}}
...
\begin{figure}[]
	...
	\caption{\textbf{Larger dimensions, smaller window size improves embedding performance.}}
