...
We embed mobility trajectories by treating organizations analogously to words and trajectories analogously to sentences, and feed the resulting "sentence" into the standard \SGNS{} model (See Fig.~\ref{fig:methods:mobility_sentence}).
...
\begin{figure}
    ...
    \caption{Relationship between the conditional probability $p(j|i)$ from Eq.\ref{eq:flux_conditional_prob} which is measured in the data and approximate functional form Eq. \ref{eq:real_embedding_relationship}}.
