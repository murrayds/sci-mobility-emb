...
For scientific mobility, like all human movements, distance matters.
...
\begin{equation}
    \cos(v_i, v_j) = \frac{v_i \cdot v_j}{\Vert v_j \Vert \Vert v_i  \Vert}
\end{equation}
