...
The embedding distance produces better predictions of actual flux than does geographic distance (Fig.~\ref{fig:supp:predict_emb_bymodel} and Fig.~\ref{fig:supp:predict_geo_bymodel}), which also holds for the subsets of only domestic and only international mobility.
