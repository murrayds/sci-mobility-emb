...
Also, we take one step further and find that the length of the organization vector, distance from the origin of the vector space, provides additional insight into the characteristics of the organization. The length of the vector tends to increase proportion to the number of unique researchers in the organization and it decreases after a certain point, yield ``boomerang" -shape curve (Fig.~\ref{fig:length}a).  Almost the prestigious university vector is close to the origin compared to the number of the researcher and this pattern is consistent for all organizations (Fig.~\ref{fig:length}b). This pattern also observed in natural language suggesting the length of the vector represents the word significance~\autocite{schakel2015measuring}.

We find that the length of the vector captures the connection diversity of the organization compare to its size. The length of the vector is correlated with the number of connections to other organizations divided by the number of researchers, which can be interpreted as connection diversity compared to their size (Fig.~\ref{fig:length}b, inset). This suggests that researchers in the organization with a long vector have less freedom to move to other organizations compare to their size while researchers in the organization with short vector have more freedom to move. This observation can also be related to the organization's strategy. Most prestigious universities have policies that can enhance their collaboration with other organizations such as visiting program, giving additional affiliation to the researcher. We also show a correlation between the length of the vector and various organization-level factors such as diverse rankings,  amount of the funding, number of doctorates granted (Fig.~\ref{fig:supp:length_vs_metaInfo}), indicating the length of the organization vector capture diverse characteristics of the organization.
