...
Some affiliations are mapped to two organizations, one specific, and one more general, as a result of the disambiguation procedure. 
...
\begin{figure}[hp!]
	...
	\caption{
		...
		The grey box corresponds to the top 20 and bottom 20 ranks. 
	  	The estimate of the spearman rank correlation between the SimAxis and Times ranking is 0.81 (n = 145).
	}
\end{figure}
