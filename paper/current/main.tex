...
We fit the gravity model given by Eq.~\ref{eq:gravity_basic} (see Methods) and computed the expected flux  $\hat{T}_{ij}$ using the geographic distance and the embedding distance as parameters.
