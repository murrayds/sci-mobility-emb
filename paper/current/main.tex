...
Distance between vectors in the learned embedding space explains and predicts real mobility between organizations better than  geographic distance, emerging from an underlying connection between the neural embedding model and the gravity model.
...
In addition to providing a data-driven functional distance, this approach is computationally efficient, scalable for large datasets, robust to noise, and are readily interpretable using an array of unique techniques based on simple vector arithmetic.
