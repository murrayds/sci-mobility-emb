...
For example, Chinese organizations have a longer average embedding vector length ($\bar{l} = 4.81$) than organizations in the United States ($\bar{l} = 0.421$), reflecting the tendency for organizations in the United States to appear more frequently in more different contexts than Chinese organizations. 
