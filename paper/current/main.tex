...
In addition to learning geography, its clear that the skip-gram model is also encoding the latent prestige hierarchies of academic mobility. 
...
By learning a distance directly from the data, the skip-gram model effectively and efficiently captures a robust measure of semantic distance between entities, all with existing tools and minor data processing. 
...
The consequences of these changes are far-reaching, and how nations respond to them will shape the future of the scientific enterprise~\autocite{chinchilla2018travelban, wagner2017open, sugimoto2017mostimpact}.
