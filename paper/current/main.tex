...
\begin{figure}[h!]
	...
	\caption{
		...
		\textbf{b.} This convex pattern repeats globally for all organizations across all countries, shown for the United States, Germany, China, and others (loess regression line shown). 
