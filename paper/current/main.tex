...
\begin{figure}[p!]
	...
	\caption{
		\textbf{Extend and nature of mobility by country.}
		\textbf{a.}
		...
		The countires with the most mobile researchers are the United States, China, France, Great Britain, and Germany. 
		\textbf{b.}
		The same information, arranged into a cumulative distribution.
		The five countires with the highest mobility account for a total of 
	}
\end{figure}
