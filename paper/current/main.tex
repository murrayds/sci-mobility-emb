...
We find that the length of organization vectors---that is, the distance from the origin of the vector space---provides insight into the characteristics of organizations. 
...
This pattern has been observed in applications of neural embedding to natural language, wherein the length of word vectors was found to represent the word "significance"~\autocite{schakel2015measuring}
