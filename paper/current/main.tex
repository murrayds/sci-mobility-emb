...
Then, we can rewrite Eq.~\ref{eq:gravity_model} as,
\begin{equation}
...
where $v_w$ and $v'_w$ are ``input'' and ``output'' vector representations of each word in the vocabulary.  We use Skip-gram negative sampling, and following the work by Levy and Goldberg \cite{levy2014neural}, consider the model as implicitely performing matrix factorization as shown below,
