...
Smaller but scientifically advanced countries such as Sweden, and other large populous countries like Brazil exhibit curves similar to the United States (Fig.~\ref{fig:length}b, inset), a pattern repeated across most countries with large scientific systems (Fig.~\ref{fig:concave30}).
...
\begin{figure}[h!]
	...
	\caption{
		...
		Loess lines are also shown for organizations in Sweden, Brazil, and Egypt (\textbf{inset}).
	}
	\label{fig:length}
\end{figure}
