...
To mitigate the effect of less common organizations, we set the $f_{min}$ as  50.  It means organizations with at least 50 appearances in affiliation trajectories are included in the final embedding, as a result, 6,580 organizations, 76 \% of all organizations, are remained.
