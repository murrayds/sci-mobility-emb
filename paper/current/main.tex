...
This procedure is repeated for a dataset of U.S. flight itinerary data, in which trajectories were formed from the unique identifiers of Airports in more than 300 million passenger flight itineraries between 1993 and 2020.
As with scientific mobility, we use a neural embedding model to learn a vector-space representation of 828 U.S. airports from passenger trajectories (see Data and Methods).
