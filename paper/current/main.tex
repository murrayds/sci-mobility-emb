...
We note that this performance and the outcomes of analysis were robust to hyperparameters settings. 
...
\begin{figure}
    \centering
    \includegraphics[width=0.8\columnwidth]{\figdir/Math/approxi_proof.pdf}
