...
Geographic distance fails to capture the host of historical, linguistic, cultural, and cognitive distance that also drive mobility. 
...
Similar structures can be observed in many states (New York, California, etc.), such that prestigious university systems are separate from more regional ones (SI~TBD).
...
Employing the SemAxis approach~\autocite{an2018semaxis} we define two axes.
...
Universities geographically distance from both California and Massahcussets are less aligned with either, such as Texas (Fig.~\ref{fig:supp:semaxis_states}g)s and Florida (Fig.~\ref{fig:supp:semaxis_states}i).
...
Once these axes are constructed using university rankings, we can even relate other types of organizations that would not typically be fit onto university rankings.
...
Among research institutes, the most aligned with elite universities are typically those prestigious university-adjacent institutes such as the Whitehead Institute, the Broad Institute, and the Dana Faber institute (Fig.~\ref{fig:supp:semaxis_sectors}b); those institutes aligned with low-ranked universities tend to be ecological or agricultural institutes such as the Joseph W. Jones Ecological Research Center and the Louisiana Agriculture Center.
Among teaching organizations, the top-ranked tend to be notable private liberal arts colleges such as Wellesley College and Carleton College, whereas community colleges and military colleges tend to be more aligned with low-ranked universities (Fig.~\ref{fig:supp:semaxis_sectors}c).
