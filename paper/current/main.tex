...
For main results, we used $d=300$ and $w=1$, which were the parameters that explained the flux between organizations most (Fig. SI~\ref{fig:supp:hyperparams}).
To mitigate the effect of less common organizations, we set the $f_{min}$ as  50.  It means organizations with at least 50 appearances in affiliation trajectories are included in the final embedding, as a result, 6,580 organizations, 76 percent of all organizations, are remained.
