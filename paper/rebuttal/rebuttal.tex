...
Furthermore, we computed an embedding that attempts to directly-optimize for a gravity-law relationship between locations, one created using singular-vector decomposition (SVD) and another with multidimensional scaling (MDS). 
...
\response{
	...
	\& Goldberg's~\autocite{levy2014neural} matrix factorization \textit{word2vec}, and directly optimization of the gravity model with singular-value decomposition and multidimensional scaling.
