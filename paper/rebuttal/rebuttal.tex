...
\response{Thank you for pointing out the missing references!
	...
	Although there are existing works on trajectory-based mobility embedding, we argue that our new result establishing the mathematical equivalence of \textit{word2vec} and the gravity law, as well as our extensive evaluation with many baselines represents a novel and substantial contribution.
}
