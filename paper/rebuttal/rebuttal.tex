...
Therefore, the inferiority of dot similarity is attributed to the optimization process.
Although finding an optimal embedding is difficult in practice, a careful tuning of the optimization algorithm would close the gap between our mathematical and numerical results.
