...
The \textit{word2vec} model  implicitly approximates this matrix-factorization procedure, and so comparison to these ``Levy'' distances can demonstrate whether the approximation of neural embeddings outperform direct-calculations. Furthermore, we examined the embedding with the direct optimization of the gravity model with SVD and multidimensional scaling (MDS).
