...
Furthermore, our subsequent experiments show that our approach robustly outperforms exceeding many other baselines, even direct optimization of the gravity model.
...
\response{Thank you for this insightful comment!
	...
	We agree that the new revolutions in neural embeddings offer huge potential for the study of human mobility, however we argue that our contribution is dependent on \textit{word2vec}, both for its equivalence with the gravity model of mobility, as well as for the model's simplicity and ubiquity.
