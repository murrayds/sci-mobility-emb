...
However, this premise is not practical because the optimization algorithm (\eg stochastic gradient descent algorithm) often finds sub-optimal embeddings due to its stochasticity and being trapped in a local optimum.
