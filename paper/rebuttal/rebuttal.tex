...
Therefore, the inferiority of dot similarity is attributed to the optimization process, and a careful tuning of the optimization algorithm would close the gap between our mathematical and numerical results.
