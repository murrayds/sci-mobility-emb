...
#     plt.text(-0.2, 0.75, "SUNY\nSystem", c=c, fontproperties=prop)
#     plt.text(-1.1, -2.7, "Columbia", c=c, fontproperties=prop)
#     plt.text(-0.15, -8.4, "Cornell", c=c, fontproperties=prop)
...
#     plt.text(1.2, -0.2, "Syracuse", c=c, fontproperties=prop)
...
#     plt.text(-0.6, 2.7, "NY state\nDepartment of Health", c=c, fontproperties=prop)
    ...
    plt.legend(handles=handles, bbox_to_anchor=(1.05, 0.2), prop=prop, frameon=False)
