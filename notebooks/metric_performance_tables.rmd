...
metric_levels <- c("emb", "levyeuc", "dot", "pprjsd", "svdcos", "levycos", "geo",
                   "lapcos", "pprcos", "levydot")

metric_labels <- c("Embedding cosine", "Factorized euclidean", "Embedding dot", "PPR JSD", 
                   "SVD cosine", "Factorized cosine", "Geographic", "Laplacian cosine", "PPR cosine", "Factorized dot")
...
r2.hux <- as_hux(r2.tab) %>%
  ...
  set_right_border(1:12, 1, value = 0.5) %>%
  set_right_border(1:12, 4, value = 0.5) %>%
  set_right_border(1:12, 7, value = 0.5) %>%
